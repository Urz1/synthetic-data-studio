...
export function RegisterForm({ apiUrl, next }: RegisterFormProps) {
    ...
    <>
      <form id="auth-register-form" data-action={`${apiUrl}/auth/register`} className="space-y-4">
        ...
        <div className="grid grid-cols-2 gap-3">
          <Button asChild type="button" variant="outline" className="cursor-pointer hover:bg-accent hover:border-primary/50 transition-all duration-200 min-h-[44px]">
