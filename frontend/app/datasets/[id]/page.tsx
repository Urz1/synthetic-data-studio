  ...
  const handleReprofile = async () => {
    try {
      ...
      toast({
        title: "Error",
        description:
          err instanceof Error ? err.message : "Failed to start profiling",
        variant: "destructive",
      });
    } finally {
        ...
        <PageHeader
          ...
          actions={
            <div className="flex flex-wrap items-center gap-2">
              ...
              >
                <RefreshCw
                  className={`mr-2 h-4 w-4 ${isReprofiling ? "animate-spin" : ""}`}
                />
            ...
            <Card>
              ...
              <CardContent>
                <div className="space-y-2">
                  {dataset.schema_data?.dtypes &&
                    Object.entries(dataset.schema_data.dtypes).map(
                      ([col, dtype]) => (
                        <div
                          key={col}
