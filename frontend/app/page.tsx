...
export default function LandingPage() {
  ...
  const faqItems = [
    {
      ...
      answer:
        "Synthetic data is artificially generated data that mimics the statistical properties of real data without containing actual records. It's useful for testing, development, and sharing when original data is sensitive.",
    },
    {
      question: "How does differential privacy work?",
      answer:
        "Differential privacy adds calibrated noise during training to provide mathematical guarantees that individual records cannot be reverse-engineered from the synthetic output. You can configure the privacy budget (epsilon) based on your risk tolerance.",
    },
    {
      question: "What generators are available?",
      answer:
        "Synth Studio offers CTGAN, TVAE, and Gaussian Copula for ML-based generation from existing data. For quick prototyping without training, use Schema-Based generation to define columns and get instant realistic data.",
    },
    {
      question: "Can I self-host Synth Studio?",
      answer:
        "Yes. Synth Studio is fully open source under the MIT license. You can deploy it on your own infrastructure for complete data sovereignty.",
    },
    {
      question: "Is there an API for automation?",
      answer:
        "Yes. All functionality is available via REST API, including dataset upload, generator training, synthetic data generation, and evaluation. See our API documentation for details.",
    },
  ];
  ...
  return (
    ...
    >
      ...
      >
        <div className="container mx-auto px-6 h-16 md:h-20 flex items-center justify-between">
          ...
          <div className="hidden md:flex items-center gap-6 text-sm">
            ...
            <Button asChild variant="outline" className="rounded-full px-4">
              <AuthIntentLink href="/login" eventLocation="navbar" mode="login">
                Sign in
              </AuthIntentLink>
            </Button>
          </div>
        ...
        {mobileMenuOpen && (
          <motion.div
            ...
            className="md:hidden absolute top-full left-0 w-full bg-background border-b border-border p-6 flex flex-col gap-4"
          >
            <Link
              href="/playground"
          ...
          <div className="flex flex-wrap justify-center items-center gap-8 md:gap-16 text-center">
            ...
            <div className="flex items-center gap-2">
              ...
              <span className="text-sm md:text-base">
                <span className="font-semibold">GDPR & HIPAA</span> Ready
              </span>
            </div>
            <div className="flex items-center gap-2">
              <Layers className="h-5 w-5 text-primary" />
              <span className="text-sm md:text-base">
                <span className="font-semibold">Up to 1M Rows</span> / gen
              </span>
            </div>
            <div className="flex items-center gap-2">
      ...
      <section
        id="how-it-works"
        className="py-20 md:py-24 border-y border-border bg-muted/20"
      >
        <div className="container mx-auto px-6">
          ...
          <div className="text-center mt-8">
            ...
            >
              <Link
                href={
                  activeFlow === "schema" ? "/generators/schema" : "/datasets"
                }
              >
                {activeFlow === "schema"
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            <div className="space-y-4">
              ...
              <p className="text-muted-foreground">
                Your data never leaves your control. Configurable privacy
                budgets, full audit trails, and compliance-ready exports keep
                your team protected.
              </p>
              ...
              <div className="space-y-4">
                ...
                <div className="space-y-3 text-sm">
                  <div className="flex items-center gap-2 text-muted-foreground">
                    <Lock className="h-4 w-4 text-primary" /> Secure
                  ...
                  <div className="flex items-center gap-2 text-muted-foreground">
                    <Activity className="h-4 w-4 text-primary" /> Full Audit
                    Trail & Lineage
                  </div>
                  <div className="flex items-center gap-2 text-muted-foreground">
                    <Cloud className="h-4 w-4 text-primary" /> Self-Host or Use
                    Our Cloud
                  </div>
                </div>
              </div>
          ...
          <div className="relative overflow-hidden rounded-3xl border border-border bg-gradient-to-br from-primary/10 via-primary/5 to-transparent p-12 text-center">
            <div className="relative space-y-4">
              ...
              <p className="text-lg text-muted-foreground max-w-2xl mx-auto">
                Create privacy-preserving synthetic data in minutes. Free to
                use, open source, and self-hostable.
              </p>
              <div className="flex flex-col sm:flex-row justify-center gap-3 mt-4">
                ...
                <Button
                  ...
                  asChild
                >
                  <Link href="https://docs.synthdata.studio" target="_blank">
                    Read the Docs
                  </Link>
                </Button>
              </div>
          ...
          <div className="grid md:grid-cols-4 gap-10 mb-12">
            <div className="md:col-span-2 space-y-4">
              ...
              <p className="text-muted-foreground max-w-md text-sm">
                Open source platform for creating privacy-preserving synthetic
                data. Free to use and self-hostable.
              </p>
            ...
            <div>
              ...
              <ul className="space-y-2 text-muted-foreground text-sm">
                <li>
                  <Link
                    href="https://docs.synthdata.studio/docs/getting-started/quick-start"
                    target="_blank"
                    rel="noopener noreferrer"
                    className="hover:text-foreground"
                  >
