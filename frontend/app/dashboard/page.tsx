...
const generatorColumns = [
  ...
  },
  {
    ...
    accessor: (row: Generator) => (
      <EpsilonBadge
        epsilon={
          row.privacy_spent?.epsilon ?? row.privacy_config?.target_epsilon
        }
...
function getContextualTip(
  ...
  if (stats.active_generators > 0) {
    return `You have ${stats.active_generators} generator${
      stats.active_generators > 1 ? "s" : ""
    } training. Training typically takes 5-30 minutes depending on dataset size and epochs.`;
  }
      ...
      try {
        ...
        if (
          ...
          const apiCalls: Promise<any>[] = [
            ...
            // Fetch recent audit logs for activity feed using user-specific endpoint
            api.getMyActivity(5, 0).catch(() => []),
          ];
          ...
          // getMyActivity returns array directly
          const activityData = (results[3] as any[]) || [];
      ...
      <AppShell user={user || { full_name: "", email: "" }}>
        ...
        {!isLoading && !error && (
          <ContextualTip id="dashboard-tip" variant="info" className="mb-6">
            ...
            {getContextualTip(stats, recentGenerators)}
          </ContextualTip>
        )}
          ...
          <>
            ...
            <div className="grid gap-4 md:grid-cols-2 lg:grid-cols-4 mb-8 stagger-children">
              ...
              <MetricCard
                ...
                value={
                  stats.avg_privacy_score > 0
                    ? `${(stats.avg_privacy_score * 100).toFixed(0)}%`
                    : "N/A"
                }
            ...
            <Card className="mb-6">
              <CardHeader className="flex flex-row items-center justify-between pb-4">
                <div>
                  ...
                  <CardDescription>
                    Your latest synthetic data generators
                  </CardDescription>
                </div>
                <Button
                  variant="ghost"
            ...
            <ShowMore
              label="Show Activity Feed & Quick Actions"
              defaultOpen={false}
            >
              ...
              <div className="grid gap-6 md:grid-cols-2 lg:grid-cols-3 mb-6">
                ...
                <Card className="md:col-span-2 lg:col-span-1">
                  <CardHeader className="pb-4">
                    ...
                    <CardDescription>
                      Quick actions for recent generators
                    </CardDescription>
                  </CardHeader>
...
function QuickActionCard({
  ...
  return (
    ...
    >
      <div
        className={`rounded-xl p-3 transition-colors group-hover:scale-105 ${iconBg}`}
      >
